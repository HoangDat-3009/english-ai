...
public class ReadingExerciseService : IReadingExerciseService
{
    ...
    public async Task<ReadingExerciseDto> CreateExerciseAsync(ExerciseEntity exercise)
    {
    ...
    public async Task<ReadingExerciseDto?> UpdateExerciseAsync(int id, ExerciseEntity exercise)
    {
    ...
    public async Task<ExerciseEntity> ProcessUploadedFileAsync(IFormFile file, string createdBy)
    {
    ...
    public async Task<ExerciseEntity> ProcessCompleteFileAsync(IFormFile file, string exerciseName, string partType, string level, string createdBy)
    {
        string content = string.Empty;
    ...
    private static ReadingExerciseDto MapToDto(ExerciseEntity exercise)
    {
    ...
    private async Task LoadCreatedByAsync(ExerciseEntity? exercise)
    {
